...
var BarPropTypes = exports.BarPropTypes = _extends({
    ...
    legends: _propTypes2.default.arrayOf(_propTypes2.default.shape(_extends({
        dataFrom: _propTypes2.default.oneOf(['indexes', 'keys']).isRequired
    }, _legends.LegendPropShape))).isRequired,
